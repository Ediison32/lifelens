...
function dropFinal(e) {
    ...
    if(puntero.id != "torre_1" && puntero.id != "torre_2" && puntero.id != "torre_3" && puntero.id != "torre_4" && puntero.id != "torre_5" && puntero.id != "torre_6" && puntero.id != "torre_7"  && item != '' &&  puedoPoner) {
        ...
        puntero.innerHTML = '<div class="boxes" id="'+item+'" draggable="true"> </div>' + puntero.innerHTML;
        contador++;
    }
...
function pintar(p) {
    ...
    for(var i = 0; i < objetos[p].length; i++) {
        cajas.innerHTML += '<div class="boxes" id="'+objetos[p][i]+'" draggable="true"></div>';
    }
